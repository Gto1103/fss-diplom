...
<body>
            ...
            <section class="movie">
                <div class="movie__info">
                    ...
                    <div class="movie__description">
                        ...
                        <p class="movie__data">
                            <span class="movie__data-duration">Продолжительность: {{ $movie->duration }} мин</span>
                            <span class="movie__data-origin">Страна: {{ $movie->country }}</span>
                        </p>
                    </div>
                </div>
                        ...
                        <ul class="movie-seances__list">
                            @foreach ($movie->sessions as $seance)
                                @if ($seance->hall_id == $hall->id)
                                    <li class="movie-seances__time-block"><a
                                            class="movie-seances__time">{{ $seance->start }}</a></li>
                                @endif
                            @endforeach
                        </ul>
                    </div>
    ...
    <script type="module" src="js/sortSeancesClient.js"></script>
</body>
